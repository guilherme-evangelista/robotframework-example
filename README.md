...
👉 **[Acessar Relatório de Execução (Report.html)](https://guilherme-evangelista.github.io/robotframework-example/)**
...
```bash
git clone https://github.com/guilherme-evangelista/RobotFrameworkExample.git
